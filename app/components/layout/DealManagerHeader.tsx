...
import { Bell, Search, User, Menu, TrendingUp, Target, LogOut, ChevronDown, Settings } from 'lucide-react'
...
const DealManagerHeader = ({ title, subtitle, onMobileMenuClick }: DealManagerHeaderProps) => {
