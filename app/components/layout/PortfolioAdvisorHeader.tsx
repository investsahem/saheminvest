...
import { Bell, Search, User, Menu, TrendingUp, PieChart, LogOut, ChevronDown, Settings } from 'lucide-react'
...
const PortfolioAdvisorHeader = ({ title, subtitle, onMobileMenuClick }: PortfolioAdvisorHeaderProps) => {
