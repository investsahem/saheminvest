...
const InvestorNotificationsPage = () => {
  ...
  const notificationsByType = {
    investment_confirmed: notifications.filter(n => n.type === 'investment_confirmed').length,
    return_payment: notifications.filter(n => n.type === 'return_payment').length,
    deposit_approved: notifications.filter(n => n.type === 'deposit_approved').length,
  ...
  if (isLoading) {
    return (
      <InvestorLayout
        title={t('investor.notifications')}
        subtitle={t('investor.manage_notifications')}
      >
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-900">
                    {notificationsByType.investment_confirmed + notificationsByType.return_payment}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-purple-700">
                    {t('notifications.transactions')}
                  </p>
                  <p className="text-2xl font-bold text-purple-900">
                    {notificationsByType.deposit_approved}
                  </p>
                </div>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              <div className="flex flex-col sm:flex-row gap-4 flex-1">
                ...
                >
                  ...
                  <option value="investment_confirmed">{t('notifications.investments')}</option>
                  <option value="return_payment">{t('notifications.returns')}</option>
                  <option value="deposit_approved">{t('notifications.deposits')}</option>
                  <option value="deal_update">{t('notifications.deal_updates')}</option>
